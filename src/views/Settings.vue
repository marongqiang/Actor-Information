...
const sourceTable = reactive([
  ...
  { key: '1pondo', name: '1Pondo', site: 'www.1pondo.tv', type: 'AV', done: true, remark: '', defaultRemark: '无码' },
  { key: '10musume', name: '10musume', site: 'www.10musume.com', type: 'AV', done: true, remark: '', defaultRemark: '素人' },
  { key: 'caribbeancom', name: 'Caribbeancom', site: 'www.caribbeancom.com', type: 'AV', done: true, remark: '', defaultRemark: '无码' },
  { key: 'caribbeancompr', name: 'CaribbeancomPR', site: 'www.caribbeancompr.com', type: 'AV', done: true, remark: '', defaultRemark: '无码' },
  { key: 'c0930', name: 'C0930', site: 'www.c0930.com', type: 'AV', done: true, remark: '', defaultRemark: '素人' },
  { key: 'gcolle', name: 'Gcolle', site: 'gcolle.net', type: 'AV', done: true, remark: '', defaultRemark: '素人' },
  { key: 'getchu', name: 'Getchu', site: 'dl.getchu.com', type: 'AV', done: true, remark: '', defaultRemark: '' },
  { key: 'h0930', name: 'H0930', site: 'www.h0930.com', type: 'AV', done: true, remark: '', defaultRemark: '素人' },
  { key: 'h4610', name: 'H4610', site: 'www.h4610.com', type: 'AV', done: true, remark: '', defaultRemark: '素人' },
  { key: 'heydouga', name: 'HeyDouga', site: 'www.heydouga.com', type: 'AV', done: true, remark: '', defaultRemark: '素人' },
  { key: 'heyzo', name: 'HEYZO', site: 'www.heyzo.com', type: 'AV', done: true, remark: '', defaultRemark: '无码' },
  { key: 'javfree', name: 'JAVFREE', site: 'javfree.me', type: 'AV', done: true, remark: '', defaultRemark: '' },
  { key: 'kin8', name: 'KIN8', site: 'www.kin8tengoku.com', type: 'AV', done: true, remark: '', defaultRemark: '无码' },
  { key: 'muramura', name: 'MURAMURA', site: 'www.muramura.tv', type: 'AV', done: true, remark: '', defaultRemark: '素人' },
  { key: 'mywife', name: 'MYWIFE', site: 'mywife.cc', type: 'AV', done: true, remark: '', defaultRemark: '素人' },
  { key: 'pacopacomama', name: 'PACOPACOMAMA', site: 'www.pacopacomama.com', type: 'AV', done: true, remark: '', defaultRemark: '素人' },
  { key: 'pcolle', name: 'Pcolle', site: 'www.pcolle.com', type: 'AV', done: true, remark: '', defaultRemark: '素人' },
  { key: 'fc2hub', name: 'fc2hub', site: 'javten.com', type: 'AV', done: true, remark: '', defaultRemark: 'FC2专用' },
  { key: 'tokyohot', name: 'TOKYO-HOT', site: 'my.tokyo-hot.com', type: 'AV', done: true, remark: '', defaultRemark: '无码' },
  { key: 'ave', name: 'AVE', site: 'www.aventertainments.com', type: 'AV', done: true, remark: '', defaultRemark: '无码' },
